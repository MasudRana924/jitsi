...
// import axios from 'axios';
// import io from 'socket.io-client';
// import JitsiMeetingPage from './components/JitsiMeetingPage';
...
//   const handleCallRequest = (doctorId, doctorName) => {
//     socket.emit('requestCall', { patientId: user.id, patientName: user.name, doctorId });
//     setOutgoingCall({ doctorId, doctorName });
//   };

//   const handleCallResponse = (accepted) => {
//     if (incomingCall) {
//       socket.emit('callResponse', { roomId: incomingCall.roomId, patientId: incomingCall.patientId, doctorId: user.id, accepted });
//       setIncomingCall(null);
//       if (accepted) navigate(`/meeting/${incomingCall.roomId}`);
//     }
//   };
...
//                     <button onClick={() => handleCallRequest(doctor.id, doctor.name)} disabled={!doctor.online}>
//                       Call Doctor
//                     </button>
//                   </li>
//                 ))}
...
//             </div>
//           )}
//           <CallModal isOpen={!!incomingCall} caller={incomingCall?.patientName} onAccept={() => handleCallResponse(true)} onReject={() => handleCallResponse(false)} isDoctor={true} />
//           <CallModal isOpen={!!outgoingCall} caller={outgoingCall?.doctorName} onAccept={() => {}} onReject={() => setOutgoingCall(null)} isDoctor={false} />
//         </div>
//       )}
//     </div>
//   );
...
//         <Route path="/meeting/:roomId" element={<JitsiMeetingPage />} />
//       </Routes>
//     </Router>
//   );
// }
...
//           element={<VideoChat userInfo={userInfo} />}
//         />
//         <Route path="/success" element={<Success />} /> {/* Keep this route */}
//       </Routes>
//     </Router>
//   );
// }
